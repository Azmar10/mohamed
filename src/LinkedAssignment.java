public class LinkedAssignment<T> {
    ...
    public void removeCenter() {
        ...
        class Node<T> {
            ...
            public void main(String[] args) {
                LinkedAssignment<String> nams=new LinkedAssignment<>();
                nams.push("Geedi");
                nams.push("Abdi");
                nams.push("Sahro");
                nams.push("Subeer");
                ...
                nams.removeCenter(); // Should remove 2 center elements
                // Attempt to remove center elements again
                nams.removeCenter(); // Should remove 1 center element now
